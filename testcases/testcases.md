...
3 | no | yes | 03_no-zip | No ZIP archive. The script shall return code 12 | none needed | no
4 | yes | yes | 04_transmission-10s | Run script with ZIP archive containing nominal hex file transmitting data for 10s. This is important for the next non-nominal cases, where this hex is executed again. | log10s.zip | no
